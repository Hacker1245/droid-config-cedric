# DisplayName: Jolla cedric/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: cedric
# DeviceVariant: cedric
# Brand: Jolla
...
repo --name=adaptation-common-cedric-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-cedric-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
patterns-sailfish-device-configuration-cedric
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/cedric
